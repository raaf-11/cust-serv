...
class ChatService:  
    ...
    async def process_message(  
        ...
        if should_escalate:  
            ...
            answer = (  
                "I'm not confident I can resolve this accurately. "  
                "I've created a support ticket and escalated your request "  
                "to our support team. They'll respond to you soon. Kindly wait"  
            )  
